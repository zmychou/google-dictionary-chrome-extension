...
(function() {
            ...
            u(chrome.runtime.getURL("content.min.css"),
                function(a) {
                    var b = function(c) {
                        ...
                        this.m = c.cloneNode(!1);
                        this.m.id = "gdx-bubble-more";
                        this.h = d.cloneNode(!1);
                        this.m.appendChild(this.h);
                        this.b = c.cloneNode(!1);
                        this.b.id = "gdx-bubble-attribution";
                        this.s = d.cloneNode(!1);
                        this.v = c.cloneNode(!1);
                        this.b.appendChild(this.s);
                        this.b.appendChild(this.v);
                        this.w = c.cloneNode(!1);
    ...
    var x = function(a) {
        ...
        F = function(a) {
            ...
            var b =
                ...
                g = d[0],
                f = [a.o.left + g, a.o.top + d[1]],
                n = a.o.bottom - a.o.top,
                A = f[0] + (a.o.right - a.o.left) / 2;
            ...
            a: if (b = new E(r, l + b, r + c, l), b.top < window.pageYOffset) b = !1;
                    ...
                    b = !0
                } b ? (m = a.H, m.style.top = f[1] - 12 + "px") : (r = m, m = a.I, m.style.top = f[1] + n + "px");
            f = A - 12;
            m.style.left = f + "px";
            f - 5 > g && f + 24 + 5 < d && a.A.appendChild(m);
            a.a.style.top = r + "px";
            a.a.style.left = l + "px"
        };
        ...
        if (a.eventKey === this.u) {
            ...
            if (a.meaningObj) {
                ...
                b.attribution && ("translation" === b.type ? (this.v.innerHTML = b.attribution, this.s.className = "display-none", this.v.className =
                    "") : (this.F.innerHTML = b.attribution, b = this.F.getElementsByTagName("a")[0], this.s.href = b.href, this.s.innerHTML = b.innerHTML.replace("http://", ""), this.s.className = "", this.v.className = "display-none"), this.b.className = "")
            } else this.f.className = "display-none", this.l.innerHTML = "No definition found.", this.h.href = "https://www.google.com/search?q=" + encodeURIComponent(a.sanitizedQuery), this.h.innerHTML = 'Search the web for "' + a.sanitizedQuery + '" \u00bb';
    ...
    var G = function(a, b) {
            b === a.u && (a.l.innerHTML = "Dictionary is disabled for https pages.", a.h.href = "https://support.google.com/TODO", a.h.innerHTML = "More information \u00bb", a.m.className = "", a.f.className = "display-none", a.c.className = "display-none", a.b.className = "display-none", document.documentElement.appendChild(a.g), F(a))
        },
        H = function(a, b) {
    ...
    var I = function(a, b) {
        ...
        K = function(a, b, c, d) {
            if ("mouseup" === c) var g = "true" === d.popupSelect && I(b, d.popupSelectKey);
            else "dblclick" === c ? g = "true" === d.popupSelect && I(b, d.popupSelectKey) ? !1 : "true" === d.popupDblclick && I(b, d.popupDblclickKey) : (console.warn("Unexpected eventType: " +
                c), g = !1);
            if (g) {
                g = 0;
                for (var f = z.length; g < f; g++)
                    if (location.href.match(z[g])) return;
                if (!t(b.target)) {
                    g = null;
                    f = "";
                    ...
                    if (!(!f || 1 === f.length && 127 >= f.charCodeAt(0) && !f.match(v) || "dblclick" === c && -1 !== f.indexOf(" "))) {
                        ...
                        var n = a.u;
                        J(a, b) || H(a, g);
                        "false" === d.enableHttps && 0 === location.href.lastIndexOf("https", 0) ? G(a, n) : (window.setTimeout(function() {
                            n ===
                                this.u && (this.l.innerHTML = "Searching...", this.f.className = "display-none", this.c.className = "display-none", this.m.className = "display-none", this.b.className = "display-none", document.documentElement.appendChild(this.g), F(this))
